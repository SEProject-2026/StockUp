...
from src.domain.enums import LocationType, UnitType
...
class ReceiptItemDTO(BaseModel):
    ...
    weight: Optional[float] = Field(None, gt=0, description="Weight of the product if applicable (must be positive)")
