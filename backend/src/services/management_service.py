...
class ManagementService:
    ...
    async def view_home_code(self, user_id: UUID, home_id: UUID, home=None) -> str:
    ...
    @require_house_access
    async def answer_join_request(self, home_id: UUID, head_user_id: UUID, user_id: UUID, approved: bool, home=None) -> Home:
    ...
    @require_house_access
    async def remove_member(self, head_user_id: UUID, home_id: UUID, target_user_id: UUID, home=None) -> Home:
    ...
    @require_house_access
    async def switch_home(self, user_id: UUID, target_home_id: UUID, home=None) -> Home:
        ...
        home.can_switch_home(user_id)
        return home

    @require_house_access
    async def leave_home(self, user_id: UUID, home_id: UUID, home=None) -> None:
    ...
    @require_house_access
    async def switch_home_head(self, current_head_id: UUID, home_id: UUID, new_head_id: UUID, home=None) -> Home:
    ...
    @require_house_access
    async def delete_home(self, head_user_id: UUID, home_id: UUID, home=None) -> None:
    ...
    @require_house_access
    async def get_home_details(self, user_id: UUID, home_id: UUID, home=None) -> dict:
    ...
    @require_house_access
    async def get_join_requests(self, head_user_id: UUID, home_id: UUID, home=None) -> dict:
    ...
    @require_house_access
    async def update_expiration_range(self, head_user_id: UUID, home_id: UUID, new_range: int, home=None) -> Home:
