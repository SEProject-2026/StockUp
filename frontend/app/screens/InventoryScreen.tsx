...
import { useInventory, Category, InventoryItem } from "../inventory/inventory-store";
import BottomNavBar from "../components/BottomNavBar";

import { InventoryFiltersBar } from "../components/inventory/InventoryFiltersBar";
import { GroupedInventoryList } from "../components/inventory/GroupedInventoryList";
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.main}>
        ...
        <GroupedInventoryList
          ...
          onAddItem={() => router.push("./AddItemScreen")}
        />
